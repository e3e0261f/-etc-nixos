...

{
  ...
  environment.sessionVariables = {
    ...
    CHROMIUM_FLAGS = "--enable-features=WebUIDarkMode --force-dark-mode --enable-blink-features=ForceDarkMode";
  };
  ...
  environment.systemPackages = with pkgs; [
    ...
    ffmpeg gitoxide p7zip unrar unzip
    mtr
    ...
    kdePackages.ark
    kdePackages.dolphin
    kdePackages.kservice   # ⭐️ 加入這行，為 Dolphin 提供常駐的軟體關聯與快取構建能力！
